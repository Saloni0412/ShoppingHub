...
export default function ShippingAddressScreen() {
  ...
  useEffect(() => {
    if (!userInfo) {navigate('/signin?redirect=/shipping');}}, [userInfo, navigate]);
  ...
  const submitHandler = (e) => {
    ...
    // save user address info to local storage
  ...
  return (
    // Creation of page UI including forms for user submission of Name, Address, Country, City and Postal Code
    <div>
      <Helmet>
